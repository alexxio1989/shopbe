...
public class StripeService {
    ...
    private String API_SECRET_KEY;
	 ...
	 public StripeService() {
	    ...
	    public String createCharge(Acquisto acquisto) {
	        String id = null;
	        try {
	            Stripe.apiKey = API_SECRET_KEY;
	            Map<String, Object> chargeParams = new HashMap<>();
	            chargeParams.put("amount", (int) Math.round(acquisto.getTotale().doubleValue()) * 100);
	            chargeParams.put("currency", "EUR");
	            chargeParams.put("description", "Charge for " + acquisto.getCodiceAquisto());
	            chargeParams.put("source", acquisto.getStripeToken()); // ^ obtained with Stripe.js
